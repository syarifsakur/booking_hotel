...
<body class="bg-slate-50">
    ...
    <div class="max-w-7xl mx-auto p-4 md:p-6">
        ...
        <div class="text-sm text-slate-600 mb-6">
            ...
            <span class="font-semibold text-slate-900">Daftar Booking</span>
        </div>

        <!-- PAGE HEADER -->
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-slate-900">📋 Daftar Booking</h1>
            <p class="text-slate-600 mt-1">Kelola semua pemesanan hotel</p>
        </div>
